...
\restrict s5EftOPsY9vPlpmJXYq9IdQeZoZ0Py9Zuye79rl3kx1J5DF0VbS4087KySmrKgE
...
CREATE FUNCTION public.accept_invitation(p_token character varying) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_invite RECORD;
...
--
-- Name: bootstrap_household(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.bootstrap_household(h_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: create_household_and_insert_admin(public.theme_type); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_household_and_insert_admin(p_theme public.theme_type DEFAULT 'default'::public.theme_type) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_household_id UUID;
...
--
-- Name: get_household_member_profiles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_household_member_profiles() RETURNS TABLE(member_id uuid, profile_id uuid, name character varying, nickname character varying, gender character varying, birth_date date, avatar_url text, joined_at timestamp with time zone)
...
--
-- Name: get_household_profiles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_household_profiles() RETURNS TABLE(id uuid, name character varying, nickname character varying, gender character varying, birth_date date, avatar_url text, joined_at timestamp with time zone)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT
...
CREATE TABLE public.households (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    theme public.theme_type DEFAULT 'default'::public.theme_type,
    created_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL
);


--
-- Name: pet_tasks; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.tasks (
    ...
    requires_transaction boolean DEFAULT false NOT NULL,
...
CREATE TABLE public.transactions (
    ...
    is_pet_related boolean DEFAULT false NOT NULL,
    created_at timestamp with time zone DEFAULT timezone('utc'::text, now()) NOT NULL
);
...
--
-- Name: household_members household_members_profile_id_household_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.household_members
    ADD CONSTRAINT household_members_profile_id_household_id_key UNIQUE (profile_id, household_id);
...
--
-- Name: pet_tasks pet_tasks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pet_tasks
    ADD CONSTRAINT pet_tasks_pkey PRIMARY KEY (id);
...
--
-- Name: idx_pet_tasks_completed_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pet_tasks_completed_by ON public.pet_tasks USING btree (completed_by);


--
-- Name: idx_task_occurrences_unique_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_task_occurrences_unique_key ON public.task_occurrences USING btree (task_id, occurrence_date, occurrence_due_time);
...
ALTER TABLE ONLY public.household_invitations
    ADD CONSTRAINT household_invitations_invited_by_fkey FOREIGN KEY (invited_by) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: household_members household_members_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pet_tasks pet_tasks_completed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pet_tasks
    ADD CONSTRAINT pet_tasks_completed_by_fkey FOREIGN KEY (completed_by) REFERENCES public.household_members(id) ON DELETE SET NULL;


--
-- Name: pet_tasks pet_tasks_pet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pets pets_household_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: task_occurrences task_occurrences_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.task_occurrences
    ADD CONSTRAINT task_occurrences_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.household_members(id);
...
--
-- Name: household_invitations Admins can manage invitations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage invitations" ON public.household_invitations USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = household_invitations.household_id) AND (household_members.profile_id = auth.uid()) AND (household_members.role = 'admin'::public.member_role)))));


--
-- Name: accounts Members can delete household accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can delete household accounts" ON public.accounts FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = accounts.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: categories Members can delete household categories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can delete household categories" ON public.categories FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = categories.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: transactions Members can delete household transactions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can delete household transactions" ON public.transactions FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = transactions.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: accounts Members can insert household accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can insert household accounts" ON public.accounts FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = accounts.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: categories Members can insert household categories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can insert household categories" ON public.categories FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = categories.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: transactions Members can insert household transactions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can insert household transactions" ON public.transactions FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = transactions.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: pets Members can manage household pets; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can manage household pets" ON public.pets USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = pets.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: profiles Members can read household profiles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can read household profiles" ON public.profiles FOR SELECT USING ((EXISTS ( SELECT 1
   FROM (public.household_members self_member
     JOIN public.household_members other_member ON ((other_member.household_id = self_member.household_id)))
  WHERE ((self_member.profile_id = auth.uid()) AND (self_member.status = 'active'::public.member_status) AND (other_member.profile_id = profiles.id) AND (other_member.status = 'active'::public.member_status)))));


--
-- Name: accounts Members can update household accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can update household accounts" ON public.accounts FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = accounts.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: households Members can update their household; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can update their household" ON public.households FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = households.id) AND (household_members.profile_id = auth.uid()) AND (household_members.status = 'active'::public.member_status)))));


--
-- Name: accounts Members can view household accounts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can view household accounts" ON public.accounts FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = accounts.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: categories Members can view household categories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can view household categories" ON public.categories FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = categories.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: transactions Members can view household transactions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Members can view household transactions" ON public.transactions FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = transactions.household_id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: profiles Profiles are visible to household members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Profiles are visible to household members" ON public.profiles FOR SELECT USING (((EXISTS ( SELECT 1
   FROM (public.household_members m1
     JOIN public.household_members m2 ON ((m1.household_id = m2.household_id)))
  WHERE ((m1.profile_id = auth.uid()) AND (m2.profile_id = profiles.id)))) OR (id = auth.uid())));
...
--
-- Name: categories Users can see categories in their household; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can see categories in their household" ON public.categories FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = categories.household_id) AND (household_members.profile_id = auth.uid())))));
...
CREATE POLICY "Users can view their household" ON public.households FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.household_members
  WHERE ((household_members.household_id = households.id) AND (household_members.profile_id = auth.uid())))));


--
-- Name: household_members Users can view their own memberships; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own memberships" ON public.household_members FOR SELECT USING ((profile_id = auth.uid()));
...
--
-- Name: pet_tasks; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.pet_tasks ENABLE ROW LEVEL SECURITY;

--
-- Name: pet_tasks pet_tasks_delete_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pet_tasks_delete_by_household_member ON public.pet_tasks FOR DELETE TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.pets p
     JOIN public.household_members hm ON ((hm.household_id = p.household_id)))
  WHERE ((p.id = pet_tasks.pet_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));


--
-- Name: pet_tasks pet_tasks_insert_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pet_tasks_insert_by_household_member ON public.pet_tasks FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.pets p
     JOIN public.household_members hm ON ((hm.household_id = p.household_id)))
  WHERE ((p.id = pet_tasks.pet_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: pet_tasks pet_tasks_select_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pet_tasks_select_by_household_member ON public.pet_tasks FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.pets p
     JOIN public.household_members hm ON ((hm.household_id = p.household_id)))
  WHERE ((p.id = pet_tasks.pet_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: pet_tasks pet_tasks_update_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY pet_tasks_update_by_household_member ON public.pet_tasks FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.pets p
     JOIN public.household_members hm ON ((hm.household_id = p.household_id)))
  WHERE ((p.id = pet_tasks.pet_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.pets p
     JOIN public.household_members hm ON ((hm.household_id = p.household_id)))
  WHERE ((p.id = pet_tasks.pet_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: task_occurrences; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.task_occurrences ENABLE ROW LEVEL SECURITY;

--
-- Name: task_occurrences task_occurrences_delete_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY task_occurrences_delete_by_household_member ON public.task_occurrences FOR DELETE TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.tasks t
     JOIN public.household_members hm ON ((hm.household_id = t.household_id)))
  WHERE ((t.id = task_occurrences.task_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));


--
-- Name: task_occurrences task_occurrences_insert_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY task_occurrences_insert_by_household_member ON public.task_occurrences FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.tasks t
     JOIN public.household_members hm ON ((hm.household_id = t.household_id)))
  WHERE ((t.id = task_occurrences.task_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: task_occurrences task_occurrences_select_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY task_occurrences_select_by_household_member ON public.task_occurrences FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.tasks t
     JOIN public.household_members hm ON ((hm.household_id = t.household_id)))
  WHERE ((t.id = task_occurrences.task_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: task_occurrences task_occurrences_update_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY task_occurrences_update_by_household_member ON public.task_occurrences FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM (public.tasks t
     JOIN public.household_members hm ON ((hm.household_id = t.household_id)))
  WHERE ((t.id = task_occurrences.task_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.tasks t
     JOIN public.household_members hm ON ((hm.household_id = t.household_id)))
  WHERE ((t.id = task_occurrences.task_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
--
-- Name: tasks tasks_delete_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tasks_delete_by_household_member ON public.tasks FOR DELETE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.household_members hm
  WHERE ((hm.household_id = tasks.household_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));


--
-- Name: tasks tasks_insert_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tasks_insert_by_household_member ON public.tasks FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.household_members hm
  WHERE ((hm.household_id = tasks.household_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));


--
-- Name: tasks tasks_select_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tasks_select_by_household_member ON public.tasks FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.household_members hm
  WHERE ((hm.household_id = tasks.household_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));


--
-- Name: tasks tasks_update_by_household_member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tasks_update_by_household_member ON public.tasks FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.household_members hm
  WHERE ((hm.household_id = tasks.household_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.household_members hm
  WHERE ((hm.household_id = tasks.household_id) AND (hm.profile_id = auth.uid()) AND (hm.status = 'active'::public.member_status)))));
...
\unrestrict s5EftOPsY9vPlpmJXYq9IdQeZoZ0Py9Zuye79rl3kx1J5DF0VbS4087KySmrKgE
