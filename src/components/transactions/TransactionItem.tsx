...
export const TransactionItem: React.FC<{
    ...
    const displayDescription =
        isIncome &&
        t.category?.name &&
        t.description.toLowerCase().startsWith("ingreso a ")
    ...
    const handlePointerDown = (event: React.PointerEvent<HTMLDivElement>) => {
        if (!onDelete || !isTouchLikeDevice) return;
        ...
        <div className="relative overflow-hidden rounded-2xl">
            ...
            <div
                className={cn(
                    ...
                    onDelete && isTouchLikeDevice && "touch-pan-y",
                )}
                style={{
                    transform: `translateX(${offsetX}px)`,
                    touchAction:
                        onDelete && isTouchLikeDevice ? "pan-y" : undefined,
                }}
            ...
            >
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="text-xs text-slate-400 truncate">
                            ...
                            {showRecurrence && t.category?.name
                                ? ` • ${t.category.name}`
                                : ""}
                ...
                <div
                    className={cn(
                        ...
                        isIncome ? "text-emerald-600" : "text-secondary-600",
                    )}
                >
                    {isIncome ? "+" : "-"}
